...
model_cross_val <- function(base_formula, 
                            model_formula,
                            df,
                            group_var,
                            model_family,
  ...
  for (i in 1:num_folds) {
    ...
    # log-likelihoods are calculated on the heldout data - might want to change 
    # that as r2's are calculated on the training data; we can report rmse
    # on the heldout set
